...
final class PodcastAPIClient {
    static func searchPodcast(keyword: String,  completionHandler: @escaping (AppError?, [Podcast]?) -> Void) {
        ...
        NetworkHelper.shared.performDataTask(endpointURLString: "https://itunes.apple.com/search?media=podcast&limit=200&term=swift", httpMethod: "GET", httpBody: nil) { (appError, data, httpResponse) in
